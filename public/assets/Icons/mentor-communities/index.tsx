...
export const ClockIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M7.85641 7.59L6.30641 6.665C6.03641 6.505 5.81641 6.12 5.81641 5.805V3.755"
      stroke="#121212"
      strokeWidth="0.75"
      strokeLinecap="round"
      strokeLinejoin="round"
  ...
  >
    ...
    <defs>
      <pattern
        ...
        height="1"
      >
        <use xlinkHref="#image0_1327_30002" transform="scale(0.00195312)" />
      </pattern>
      <image
        id="image0_1327_30002"
        width="512"
        height="512"
...
export const SearchIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8.16406 0.666992C4.02193 0.666992 0.664062 4.02486 0.664062 8.16699C0.664062 12.3091 4.02193 15.667 8.16406 15.667C9.93491 15.667 11.5624 15.0533 12.8455 14.0269L15.9081 17.0896C16.2336 17.415 16.7612 17.415 17.0867 17.0896C17.4121 16.7641 17.4121 16.2365 17.0867 15.9111L14.024 12.8484C15.0503 11.5653 15.6641 9.93784 15.6641 8.16699C15.6641 4.02486 12.3062 0.666992 8.16406 0.666992ZM2.33073 8.16699C2.33073 4.94533 4.9424 2.33366 8.16406 2.33366C11.3857 2.33366 13.9974 4.94533 13.9974 8.16699C13.9974 11.3887 11.3857 14.0003 8.16406 14.0003C4.9424 14.0003 2.33073 11.3887 2.33073 8.16699Z"
      fill="#CCCCCC"
    />
  </svg>
);
...
export const MsgEditIcon = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g id="vuesax/linear/message-edit">
      <g id="message-edit">
        <path
          id="Vector"
  ...
  >
    <g id="vuesax/linear/messages-2">
      <g id="messages-2">
        <path
          id="Vector"
          d="M18.4738 17.33L18.8638 20.49C18.9638 21.32 18.0738 21.9 17.3638 21.47L13.1738 18.98C12.7138 18.98 12.2638 18.95 11.8238 18.89C12.5638 18.02 13.0038 16.92 13.0038 15.73C13.0038 12.89 10.5438 10.59 7.50375 10.59C6.34375 10.59 5.27376 10.92 4.38376 11.5C4.35376 11.25 4.34375 11 4.34375 10.74C4.34375 6.18999 8.29375 2.5 13.1738 2.5C18.0538 2.5 22.0038 6.18999 22.0038 10.74C22.0038 13.44 20.6138 15.83 18.4738 17.33Z"
          stroke="#008080"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        <path
          id="Vector_2"
          d="M13 15.7298C13 16.9198 12.56 18.0198 11.82 18.8898C10.83 20.0898 9.26 20.8598 7.5 20.8598L4.89 22.4098C4.45 22.6798 3.89 22.3098 3.95 21.7998L4.2 19.8298C2.86 18.8998 2 17.4098 2 15.7298C2 13.9698 2.94 12.4198 4.38 11.4998C5.27 10.9198 6.34 10.5898 7.5 10.5898C10.54 10.5898 13 12.8898 13 15.7298Z"
          stroke="#008080"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export const UploadPostImgIcon = () => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
  ...
  >
    <g id="vuesax/linear/image">
      <g id="image">
        <path
          id="Vector"
          d="M21.677 16.9596L18.547 9.64964C17.487 7.16964 15.537 7.06964 14.227 9.42964L12.337 12.8396C11.377 14.5696 9.587 14.7196 8.347 13.1696L8.127 12.8896C6.837 11.2696 5.017 11.4696 4.087 13.3196L2.367 16.7696C1.157 19.1696 2.907 21.9996 5.587 21.9996H18.347C20.947 21.9996 22.697 19.3496 21.677 16.9596Z"
          stroke="#008080"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        <path
          id="Vector_2"
          d="M6.96875 8C8.6256 8 9.96875 6.65685 9.96875 5C9.96875 3.34315 8.6256 2 6.96875 2C5.3119 2 3.96875 3.34315 3.96875 5C3.96875 6.65685 5.3119 8 6.96875 8Z"
          stroke="#008080"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  >
    <g id="vuesax/linear/send-2">
      <g id="send-2">
        <path
          id="Vector"
          d="M7.39969 6.82015L15.8897 3.99015C19.6997 2.72015 21.7697 4.80015 20.5097 8.61015L17.6797 17.1002C15.7797 22.8102 12.6597 22.8102 10.7597 17.1002L9.91969 14.5802L7.39969 13.7402C1.68969 11.8402 1.68969 8.73015 7.39969 6.82015Z"
          stroke="#008080"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        <path
          id="Vector_2"
          d="M10.1094 14.1505L13.6894 10.5605"
          stroke="#008080"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
