...
const MenteeCommunities: React.FC = () => (
  <div className="menteecommunities flex flex-col justify-center pt-[80px] lg:pt-[85px] ">
    <HomeNavBar />
    ...
    <div className=" w-[396px] sm:w-[90vw] md:max-w-none md:w-[85vw] lg:w-[calc(100vw-150px)] xl:w-[calc(94vw)] 2xl:w-[90vw]   border border-transparent  mx-auto overflow-hidden">
      {" "}
      <Slider
        slideInfo={[
          "Item 1",
