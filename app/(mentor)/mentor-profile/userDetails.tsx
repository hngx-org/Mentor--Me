...
const UserDetails = () => (
    <div className=" ml-14 mt-12 mb-6 ">
        <header className=" flex gap-20 ">
            <p className=" text-lg font-Inter font-medium border-b-4 border-Accent1">
                Overviwe
            </p>
        ...
        <div className="  mt-8 lg:grid lg:grid-cols-2 md:grid md:grid-cols-2  ">
            <div className=" mb-32 md:mb-2 lg:mb-4">
                <h3 className=" mt-8 font-Inter text-base font-medium text-black mb-5 ">
                    Bio
                </h3>
                <p className=" w-[250px] h-20 lg:w-[500px] md:w-[300] mb-16 lg:mb-8 md:mb-8 text-Neutra40">
                    Experienced product designer with over 5 years of experience in
            ...
            <div>
                ...
                <div className=" flex items-center gap-3 ">
                    <Image src={Awards} width={30} height={20} alt="facebook" />
                    <div>
        ...
        <p className=" lg:mt-[8px] md:mt-0 mt-[60px] text-Accent1">
            {" "}
            <a href="/mentor-profile" className="">
                See more
            </a>
        </p>
    </div>
