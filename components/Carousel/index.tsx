  ...
  return (
    <div className="flex flex-col xl:flex-row w-full  xl:mb-0 xl:justify-between justify-center xl:items-start items-center gap-[40px]  ">
      <div className="w-full ">
        ...
        <p className="text-[0.85rem] sm:text-lg text-center md:text-left font-Inter py-[1rem] max-w-[500px]">
          {text}
        </p>
      </div>

      <div className="flex w-full  xl:max-w-[700px]  sm:max-w-[500px] justify-center  ">
