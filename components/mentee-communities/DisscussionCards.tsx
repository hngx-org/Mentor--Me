...
const DiscussionCards: React.FC<Props> = ({ title, members, desc, id = 1 }) => (
  <div className="discussioncard lg:pt-4 lg:px-[19px] lg:pb-[30px] px-2 py-4 border border-Neutra10 lg:rounded-[8px] rounded-[6.2px] justify-center items-center flex flex-col flex-shrink-0 gap-2 lg:w-[295px]  md:w-[23vw] w-[40vw] max-w-[187px] md:min-h-[220px]  h-fit   ">
