  ...
  <button
    ...
    className={`
          ${getVariant(variant)}  transition duration-75  ${
            !paddingLess &&
            "xl:w-[140px] xl:h-[42px]  md:h-[40px] md:w-[100px] w-[120px] h-[40px] text-sm font-medium"
          }  ${
            !square && "rounded-[6px] sm:rounded-[8px] "
          } active:scale-95 ${className}  ${
            !iconPresent && "flex justify-center items-center gap-2"
          } `}
  >
