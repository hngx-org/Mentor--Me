        ...
        <div className="mb-[3.5rem] md:mb-0 sm:max-w-[600px] mx-auto md:mx-0   w-full">
          <div className="w-full md:max-xl:w-9/10 mx-auto md:max-xl:mx-0 md:w-ful  xl:w-full ">
            ...
            <div className="py-[3rem] relative">
              ...
              <button
                type="button"
                className="border bg-[black] text-[white] text-[0.7rem] md:text-[0.8rem] w-1/4 md:w-1/5 max-w-[134px] rounded-[8px] absolute py-[0.7rem] md:py-[0.75rem] bottom-[3.4rem] right-[0.5rem] "
              >
                Search
              </button>
            </div>
