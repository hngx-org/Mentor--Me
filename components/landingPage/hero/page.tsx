  ...
  return (
    <section className="py-[5rem]">
      <div className="md:w-5/6 md:max-lg:w-9/10 md:m-auto md:flex justify-between items-center">
        <div className="mb-[5rem] md:mb-0 max-w-[520px] mx-auto md:mx-0 md:max-w-[636px] md:max-xl:max-w-[480px] md:pr-[1rem]">
          <div className="w-9/10 md:max-xl:w-9/10 mx-auto md:max-xl:mx-0 md:w-full ">
            ...
            <div className="py-[3rem] relative">
              ...
              />
              <input
                className="bg-[white] py-[1.1rem] md:py-[1.2rem] pl-[2.4rem] md:pl-[3.5rem] border-[1px] w-full text-[0.7rem] md:text-[0.8rem] rounded-[6px] outline-none"
                type="text"
