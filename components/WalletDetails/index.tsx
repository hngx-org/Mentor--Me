    ...
    <div className="p-12 text-left">
        ...
        <div className="mt-1">
          <div className="flex justify-left">
            <span
              className={`${selectedTab === "This week" ? "border-b-2 border-blue-500" : ""} cursor-pointer mx-2 py-2`}
              onClick={() => handleTabClick("This week")}
            >
              This week
            </span>
            <span
              className={`${selectedTab === "Overtime" ? "border-b-2 border-blue-500" : ""} cursor-pointer mx-2 py-2`}
        ...
        <div className="flex flex-col mt-4">
          <div className="bg-black text-white-100 p-8 mb-7 rounded" style={{ color: "white" }}>
          ...
          <div className="mt-4 self-end">
            <button
              ...
              className="bg-black text-white-100 py-2 px-2 rounded hover-bg-blue-600"
              style={{ color: "white" }}
            >
              Withdraw now
            </button>
