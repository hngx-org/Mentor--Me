...
const SearchCommunitySearchbar = ({
  ...
  return (
    <form
      ...
      className="p-4 md:p-0 md:pl-6 border-[1px] border-solid border-Neutra20 md:border-NeutalBase rounded-lg max-w-[90vw] w-[90vw] md:w-[370px] lg:w-[610px] flex items-center md:justify-between gap-3"
    >
