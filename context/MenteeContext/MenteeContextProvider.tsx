...
import { MenteeCommunityContext } from "./MenteeCommunityContext";
...
export function MenteeCommunityProvider({ children }: { children: ReactNode }) {
  ...
  // Function to update the sliderInfo
  const updateSliderInfo = (data: Community[]) => {
    setSliderInfo(data);
  };

  return (
    // eslint-disable-next-line react/jsx-no-constructed-context-values
    <MenteeCommunityContext.Provider value={{ sliderInfo, updateSliderInfo }}>
      {children}
    </MenteeCommunityContext.Provider>
  );
}
